...
CREATE TABLE `car` (
  ...
  `car_number` varchar(10) DEFAULT NULL COMMENT '容易辨别的唯一标识即可，可以是车牌号',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `datastream` VALUES ('humidity', null, null, null, 'Relative Humidity', 'RH%', '2018-05-07 22:49:49', '29566363', 'e42aefc4-8fe2-5eb8-8198-7e333d699647');
INSERT INTO `datastream` VALUES ('humidity', null, null, null, 'Relative Humidity', 'RH%', '2018-05-07 22:49:49', '29566372', 'be918c86-fa5c-5aac-a6a6-2fd8724b68d3');
INSERT INTO `datastream` VALUES ('location', null, 'zzz', null, null, null, '2018-05-07 22:49:49', '29566363', 'bd01dcb4-a05a-46ea-bd1d-d8fa5181431c');
INSERT INTO `datastream` VALUES ('location', null, 'zzz', null, null, null, '2018-05-07 22:49:49', '29566372', 'c7d9a16b-9892-46d2-80e7-912a68675e4a');
INSERT INTO `datastream` VALUES ('obliquity', null, null, null, '?', '°', '2018-05-07 22:49:49', '29566363', 'c868d81a-595f-54e7-bfb7-f5995d072ebb');
INSERT INTO `datastream` VALUES ('obliquity', null, null, null, '?', '°', '2018-05-07 22:49:49', '29566372', '7567ef03-7d1e-517b-86ca-20b138f709d9');
INSERT INTO `datastream` VALUES ('position', null, null, null, '', '', '2018-05-07 22:49:49', '29566363', '8ee5818c-e462-57ae-a728-b1477dbc22d3');
INSERT INTO `datastream` VALUES ('position', null, null, null, '', '', '2018-05-07 22:49:49', '29566372', 'e3cbc30e-67a8-50d1-ac6c-d5a4e20a3d48');
INSERT INTO `datastream` VALUES ('pressure', null, null, null, '?', 'Pa', '2018-05-07 22:49:49', '29566363', '2b6dbf87-3b34-5a72-8b21-eb6d0188ddd2');
INSERT INTO `datastream` VALUES ('pressure', null, null, null, '?', 'Pa', '2018-05-07 22:49:49', '29566372', '5cfb3776-a124-593b-a8e7-30982140798e');
INSERT INTO `datastream` VALUES ('temperature', null, '60', null, 'celsius', 'C', '2018-05-07 22:49:49', '29566363', '87989383-99f4-5086-a2e1-22fe2e141ab9');
INSERT INTO `datastream` VALUES ('temperature', null, '60', null, 'celsius', 'C', '2018-05-07 22:49:49', '29566372', '430ff55d-a6fb-54c1-bf8b-09367993bcc8');
...
-- Records of device
-- ----------------------------
INSERT INTO `device` VALUES ('29566363', null, '2018-05-07 22:49:49', null, null, 'C89346DA4373', '\0', 'HTTP', 'myedpdevice', null, null, null);
INSERT INTO `device` VALUES ('29566372', null, '2018-05-07 22:49:49', null, null, '11111111', '\0', 'HTTP', 'myedpdevice', null, null, null);
...
CREATE TABLE `orderDeviceCar` (
  ...
  `order_numbering` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
