...
-- ----------------------------
INSERT INTO `datastream` VALUES ('humidity', null, null, null, 'Relative Humidity', 'RH%', '2018-05-09 15:57:44', '29566363', 'e42aefc4-8fe2-5eb8-8198-7e333d699647');
INSERT INTO `datastream` VALUES ('humidity', null, null, null, 'Relative Humidity', 'RH%', '2018-05-09 15:57:44', '29566372', 'be918c86-fa5c-5aac-a6a6-2fd8724b68d3');
INSERT INTO `datastream` VALUES ('location', null, 'zzz', null, null, null, '2018-05-09 15:57:44', '29566363', 'bd01dcb4-a05a-46ea-bd1d-d8fa5181431c');
INSERT INTO `datastream` VALUES ('location', null, 'zzz', null, null, null, '2018-05-09 15:57:44', '29566372', 'c7d9a16b-9892-46d2-80e7-912a68675e4a');
INSERT INTO `datastream` VALUES ('obliquity', null, null, null, '度', '°', '2018-05-09 15:57:44', '29566363', 'c868d81a-595f-54e7-bfb7-f5995d072ebb');
INSERT INTO `datastream` VALUES ('obliquity', null, null, null, '度', '°', '2018-05-09 15:57:44', '29566372', '7567ef03-7d1e-517b-86ca-20b138f709d9');
INSERT INTO `datastream` VALUES ('position', null, null, null, '', '', '2018-05-09 15:57:44', '29566363', '8ee5818c-e462-57ae-a728-b1477dbc22d3');
INSERT INTO `datastream` VALUES ('position', null, null, null, '', '', '2018-05-09 15:57:43', '29566372', 'e3cbc30e-67a8-50d1-ac6c-d5a4e20a3d48');
INSERT INTO `datastream` VALUES ('pressure', null, null, null, '帕', 'Pa', '2018-05-09 15:57:44', '29566363', '2b6dbf87-3b34-5a72-8b21-eb6d0188ddd2');
INSERT INTO `datastream` VALUES ('pressure', null, null, null, '帕', 'Pa', '2018-05-09 15:57:44', '29566372', '5cfb3776-a124-593b-a8e7-30982140798e');
INSERT INTO `datastream` VALUES ('temperature', null, '60', null, 'celsius', 'C', '2018-05-09 15:57:44', '29566363', '87989383-99f4-5086-a2e1-22fe2e141ab9');
INSERT INTO `datastream` VALUES ('temperature', null, '60', null, 'celsius', 'C', '2018-05-09 15:57:44', '29566372', '430ff55d-a6fb-54c1-bf8b-09367993bcc8');
...
CREATE TABLE `datastreampoint` (
  `device_id` bigint(20) NOT NULL,
  `at` varchar(255) NOT NULL,
  `obliquity` varchar(255) DEFAULT NULL,
  ...
  CONSTRAINT `datapoint_deviceId` FOREIGN KEY (`device_id`) REFERENCES `device` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Records of device
-- ----------------------------
INSERT INTO `device` VALUES ('29566363', null, '2018-05-09 15:57:44', null, null, 'C89346DA4373', '\0', 'HTTP', 'myedpdevice', null, null, null);
INSERT INTO `device` VALUES ('29566372', null, '2018-05-09 15:57:43', null, null, '11111111', '\0', 'HTTP', 'myedpdevice', null, null, null);
...
CREATE TABLE `order` (
  ...
  `complete` tinyint(1) DEFAULT '0' COMMENT '订单是否已完成（0为未完成，1为已完成）',
  PRIMARY KEY (`id`),
...
-- Records of order
-- ----------------------------
INSERT INTO `order` VALUES ('1', '1', '1', '10', '10', '0');
INSERT INTO `order` VALUES ('2', 'tesdsvduserid', '2', '20', '11', '0');
...
CREATE TABLE `orderitem` (
  ...
  `device_auth_info` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '对应device表（id还是auth_info待定）',
  `car_id` int(20) DEFAULT NULL,
  `order_id` bigint(20) NOT NULL,
  PRIMARY KEY (`device_auth_info`,`order_id`),
  KEY `carId` (`order_id`) USING BTREE,
  KEY `orderId` (`order_id`) USING BTREE,
  KEY `orderItem_carId` (`car_id`),
  KEY `deviceAuthInfo` (`device_auth_info`) USING BTREE,
  CONSTRAINT `orderId` FOREIGN KEY (`order_id`) REFERENCES `order` (`id`),
  CONSTRAINT `orderItem_carId` FOREIGN KEY (`car_id`) REFERENCES `car` (`id`),
  CONSTRAINT `orderItem_deviceAuthInfo` FOREIGN KEY (`device_auth_info`) REFERENCES `device` (`auth_info`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of orderitem
-- ----------------------------
INSERT INTO `orderitem` VALUES ('tesdsvduserid', '11111111', '2', '2');
